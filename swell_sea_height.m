function swell_sea_height(buoy_name)
...
figure(1)
plot(1:length(S1),data1(:,1),'k.','MarkerSize',12)
 hold on
 plot(1:length(S1),data1(:,2),'r.','MarkerSize',12)
 legend('buoy-hs','ww3-hs')
% %legend('buoy-tm0','ww3-tm0')
%title([filename(1:4),'-HS-comparison'])
ylabel('Significant Wave Height')
figure(2)
plot(data1(:,3),'k.','MarkerSize',12)
hold on
plot(data1(:,4),'r.','MarkerSize',12)
legend('buoy-hsa','ww3-hsa')
% %legend('buoy-tm0','ww3-tm0')
 %title([f_name1(1:4),'-HS-comparison'])
% %xlabel('Year(2014-3hrly)')
 ylabel('Swell Wave Height')
figure(3)
 plot(data1(:,5),'k.','MarkerSize',12)
 hold on
 plot(data1(:,6),'r.','MarkerSize',12)
 legend('buoy-hsb','ww3-hsb')
% %legend('buoy-tm0','ww3-tm0')
% %title([filename(1:4),'-HS-comparison'])
% title([f_name1(1:4),'-TM-comparison'])
% %xlabel('Year(2014-3hrly)')
 ylabel('Wind Sea heght')
figure(4)
 plot(data1(:,7),'k.','MarkerSize',12)
 hold on
 plot(data1(:,8),'r.','MarkerSize',12)
